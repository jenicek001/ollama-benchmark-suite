...
echo "4. gpt-oss:20b          - 20B params, ~10GB (OpenAI Open Source)"
echo "5. gpt-oss:120b         - 120B params, ~65GB (OpenAI Open Source Large)"
echo "6. mixtral:8x22b        - 141B params (39B active), ~80GB (MoE)"
echo "7. deepseek-r1:70b      - 70B params, ~43GB (Reasoning model)"
echo "8. ministral-3:14b      - 14B params, ~9GB (Mistral's edge model)"
echo "9. OpenEuroLLM-Czech    - ~8B params, ~8.1GB (Czech optimized)"
echo "10. czellama3           - ~8B params, ~4.7GB (Czech Llama3)"
echo "--------------------------------------------------"
echo ""
